...
if __name__ == "__main__":
        ...
        # constant values
        #cities = {0: 'Delhi', 1: 'Mumbai', 2: 'Pune', 3: 'Kolkata', 4: 'Gujrat', 5: 'Banglore', 6: 'J&K', 7: 'Nagaland'}
        cities = {0: 'Grand Rapids', 1: 'Saginaw', 2: 'Detroit', 3: 'Toledo', 4: 'Kalamazoo'}
